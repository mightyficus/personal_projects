...
def access_token(payload):
    ...
    temp_payload = {
        "client_id":        payload["DexcomAPI"]["client_id"],
        "client_secret":    payload["DexcomAPI"]["client_secret"],
        "refresh_token":    payload["DexcomAPI"]["refresh_token"],
    ...
    if response.status_code != 200:
        ...
        oauth = requests_oauthlib.OAuth2Session(payload["DexcomAPI"]["client_id"], 
                                                redirect_uri=payload["DexcomAPI"]["redirect_uri"], 
    ...
    print("Token is valid. Updating...")
    payload["DexcomAPI"]["access_token"] = data["access_token"]
    payload["DexcomAPI"]["refresh_token"] = data["refresh_token"]
